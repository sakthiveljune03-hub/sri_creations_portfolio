...
export const PORTFOLIO_PROJECTS: Project[] = [
  {
    ...
    client: "Volt Motors",
    category: "Commercial",
    thumbnail: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto,so_0/v1784348683/saturation_xdomts.jpg",
    videoUrl: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto/v1784348683/saturation_xdomts.mp4",
    duration: "1:30",
    year: "2025",
    description: "A fast-paced, neon-lit nocturnal commercial showcasing the electric performance of Volt's new hypercar. Featuring dynamic speed-ramps, heavy sound design, and custom anamorphic lens flare effects.",
    skills: ["Speed Ramping", "Sound Design", "Anamorphic Grading", "Chronos Retime"]
  },
  {
    id: "ethereal-echoes",
    ...
    thumbnail: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto,so_0/v1784380468/SUCCESS_vqufsi.jpg",
    videoUrl: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto/v1784380468/SUCCESS_vqufsi.mp4",
    duration: "3:45",
    year: "2026",
    description: "An immersive, dreamlike music video utilizing multi-layered exposure blends, glowing liquid morph transitions, and heavy bass-synchronized lighting enhancements.",
    skills: ["Liquid Transitions", "Color Grading", "Beat Syncing", "Multi-Exposure"]
  },
  {
    id: "shadows-of-kyoto",
    ...
    thumbnail: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto,so_0/v1784348741/wed_fnl_uin8wc.jpg",
    videoUrl: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto/v1784348741/wed_fnl_uin8wc.mp4",
    duration: "5:20",
    year: "2025",
    description: "A serene, cinematic journey through the historic alleys of Kyoto. Focuses on storytelling through quiet pacing, ambient Foley design, and highly organic Kodak 2383 film LUT emulsion grading.",
    skills: ["Kodak 2383 Film Emulation", "Foley Sound Design", "Visual Pacing", "HDR Mastering"]
  },
  {
    id: "cyberpunk-2088",
    title: "Echoes of Cyberpunk",
    client: "Aether Indie Studios",
    category: "Short Film",
    thumbnail: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto,so_0/v1784348707/lut_ydioxp.jpg",
    videoUrl: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto/v1784348707/lut_ydioxp.mp4",
    duration: "8:15",
    year: "2026",
    description: "A sci-fi cinematic short film set in a rain-drenched cyberpunk metropolis. Features complex green-screen composting, heavy particle overlay effects, and custom UI holographic soundscapes.",
    skills: ["Chroma Keying", "VFX Compositing", "Holographic Overlays", "Dialogue Editing"]
  },
  {
    id: "last-summit",
    title: "",
    client: "",
    category: "",
    thumbnail: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto,so_0/v1784403158/gabrella_4k_1_1_mjd73m.jpg",
    videoUrl: "https://res.cloudinary.com/xdzjp4sb/video/upload/f_auto,q_auto/v1784403158/gabrella_4k_1_1_mjd73m.mp4",
    duration: "",
    year: "",
    description: "",
    skills: []
